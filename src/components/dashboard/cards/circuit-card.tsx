...
export function CircuitCard({
 ...
 return (
  <div className="bg-white rounded-xl border-2 hover:border-green-400 hover:shadow-lg transition-all cursor-pointer group">
   {isCreate ? (
    <div className="aspect-[3/2] flex items-center justify-center bg-green-50 rounded-lg border-2 border-dashed border-green-300">
     <div className="text-center">
      <PlusIcon />
      <p className="text-xs font-bold text-green-600 px-2">{title}</p>
     </div>
    </div>
   ) : (
    <>
